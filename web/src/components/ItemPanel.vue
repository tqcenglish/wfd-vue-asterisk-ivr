<template>
    <div class="itemPanel" :style="{'height': height+'px'}">
        <el-collapse v-model="activeNames" >
             <el-collapse-item :title="'IVR 节点'" name="0">
                <img data-item="{clazz:'ivr-start',size:'30*30',label:''}"
                     :src="require('../assets/ivr/ivr.svg')" style="width:42px;height:42px" />
                <div>IVR 开始节点</div>

                <img data-item="{clazz:'ivr-exten',size:'30*30',label:''}"
                     :src="require('../assets/ivr/sip-exten.svg')" style="width:42px;height:42px" />
                <div>分机节点</div>
