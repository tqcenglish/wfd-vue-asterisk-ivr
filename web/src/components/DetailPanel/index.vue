<template>
    <div class="detailPanel" :style="{'height':height+'px'}">
        ...
        <IVRStartDetail v-else-if="model.clazz === 'ivr-start'" :model="model" :onChange="onChange" :readOnly="true" />
        <IVRExtenDetail v-else-if="model.clazz === 'ivr-exten'" :model="model" :onChange="onChange" :readOnly="true" />
        <FlowDetail v-else-if="model.clazz === 'flow'" :model="model" :onChange="onChange" :readOnly="true" />
    </div>
</template>
<script>
  ...
  import IVRStartDetail from "./IVRStartDetail"
  import IVRExtenDetail from "./IVRExtenDetail"
