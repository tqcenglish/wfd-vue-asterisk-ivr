...
export default function(G6) {
  ...
  G6.registerNode('ivr-start-node', {
    options:  G6.Util.deepMix({}, startDefaultOptions, {icon: require('../assets/ivr/ivr.svg')}),
    afterDraw(cfg, group) { this.runAnimate(cfg,group) },
  }, 'start-node');
  G6.registerNode('ivr-exten-node', {
    options:  G6.Util.deepMix({}, startDefaultOptions, {icon: require('../assets/ivr/sip-exten.svg')}),
    afterDraw(cfg, group) { this.runAnimate(cfg,group) },
  }, 'end-node');
}
